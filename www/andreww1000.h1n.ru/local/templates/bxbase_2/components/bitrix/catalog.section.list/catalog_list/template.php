...
<div class="catalog-section-list <? echo $arCurView['CONT']; ?>"><?
...
{
?><?//debugg($arResult);?>
<?debugg('$arParams[\'VIEW_MODE\']='.$arParams['VIEW_MODE']);?>
<ul class="ul-list <? echo $arCurView['LIST']; ?>">
    <?
...
?>
    <div><b>Подразделов больше нет</b></div>
<? } ?>
</div>