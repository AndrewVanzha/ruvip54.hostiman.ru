...
<?global $subSections;
$subSections = false;
//$arSectionsID = Array();?><?//debugg($arResult);?>
...
<div>
    ...
    //$GLOBALS['sectionsFilter'] = array("SECTION_ID" => $arResult["VARIABLES"]["SECTION_ID"]);
    $APPLICATION->IncludeComponent(
...
<? debugg('news.list / list_equipment');
    $APPLICATION->IncludeComponent(
        "bitrix:news.list",
        "list_equipment",
        Array(
