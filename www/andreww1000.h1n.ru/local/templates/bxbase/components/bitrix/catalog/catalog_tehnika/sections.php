...
unset($sectionListParams);
	...
	debugg('catalog.smart.filter');
    $APPLICATION->IncludeComponent( // добавка для работы с фильтром из главной index.php
...
$intSectionID = $APPLICATION->IncludeComponent( // добавка для работы с фильтром из главной index.php
...
/* если есть catalog.section, этот компонент мешает, дублирует вывод
