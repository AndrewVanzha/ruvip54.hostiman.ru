                    ...
                    <div class="kino--wrap">
                        <figure class="kino">
                            <video controls="true" autoplay muted loop playsinline>
                                <source src="/upload/img-generator/tiger_card.mp4" type="video/mp4"/>
                                <?/*?>
...
<?*/?>
                    ...
                    <div class="congratulate-block">
                        <div class="congratulate-wrap">
                            ...
                            <div class="congratulate-star">
                                <img src="/upload/img-generator/star.png" alt="Звездочка">
                            ...
                            <div class="congratulate-wave">
                                <img src="/upload/img-generator/wave.png" alt="Значок волны">
	...
	<div class="api-ping">
        <h2>Проверка работы АПИ - запись в БД</h2>
